...
static void cwd686_init_sequence(struct cwd686 *ctx)
{
	...
	dcs_write_seq(0xB0, 0x54, 0x32, 0x23, 0x45, 0x44, 0x44, 0x44, 0x44,
		      0x9F, 0x00, 0x01, 0x9F, 0x00, 0x01);
	dcs_write_seq(0xB1, 0x32, 0x84, 0x02, 0x83, 0x29, 0x06, 0x06, 0x72,
		      0x06, 0x06);
	dcs_write_seq(0xB2, 0x73);
	dcs_write_seq(0xB3, 0x0B, 0x09, 0x13, 0x11, 0x0F, 0x0D, 0x00, 0x00,
		      0x00, 0x03, 0x00, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03,
		      0x03, 0x05, 0x07);
	dcs_write_seq(0xB4, 0x0A, 0x08, 0x12, 0x10, 0x0E, 0x0C, 0x00, 0x00,
		      0x00, 0x03, 0x00, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03,
		      0x03, 0x04, 0x06);
	...
	dcs_write_seq(0xBD, 0x43, 0x0E, 0x0E, 0x50, 0x50, 0x29, 0x10, 0x03,
		      0x44, 0x03);
	...
	dcs_write_seq(0xC8, 0x7C, 0x68, 0x59, 0x4E, 0x4B, 0x3C, 0x41, 0x2B,
		      0x44, 0x43, 0x43, 0x60, 0x4E, 0x55, 0x47, 0x44, 0x38,
		      0x27, 0x06, 0x7C, 0x68, 0x59, 0x4E, 0x4B, 0x3C, 0x41,
		      0x2B, 0x44, 0x43, 0x43, 0x60, 0x4E, 0x55, 0x47, 0x44,
		      0x38, 0x27, 0x06); //GAMMA2.2
...
static int cwd686_probe(struct mipi_dsi_device *dsi)
{
	...
	drm_panel_init(&ctx->panel, dev, &cwd686_drm_funcs,
...
static const struct of_device_id cwd686_of_match[] = { { .compatible =
								 "cw,cwd686" },
						       {} };
